...
<form action="<?php echo base_url('espectaculos/update/') . $espectaculo->id; ?>" method="POST" class="text-light bg-dark rounded-0 border border-2 border-primary p-4">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control bg-white text-dark border" id="tickets" name="tickets" value="<?php echo $espectaculo->tickets; ?>" placeholder="Ingrese el numero de tickets" required>
  </div>
  <div class="mb-3">
    <label for="price" class="form-label">Precio:</label>
    <input type="number" class="form-control bg-white text-dark border" id="price" name="price" value="<?php echo $espectaculo->price; ?>" placeholder="Ingrese el precio" required>
  </div>
