...
<form action="<?php echo base_url('espectaculos/store'); ?>" method="POST" enctype="multipart/form-data" class="text-light bg-dark rounded-0 border border-2 border-primary p-5">
  <div class="mb-3">
